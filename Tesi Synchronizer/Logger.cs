    ...
    public sealed class Logger : IDisposable
    {
        ...
        private void DrawItemHandler(object sender, DrawItemEventArgs e)
        {
            if (e.Index >= 0)
            {
                ...
                e.Graphics.DrawString(FormatALogEventMessage(logEvent, _messageFormat), new Font("Lucida Console", 10f, FontStyle.Regular), new SolidBrush(color), e.Bounds);
                e.DrawFocusRectangle();
            }
        }
        ...
        public Logger(ListBox listBox) : this(listBox, DEFAULT_MESSAGE_FORMAT, DEFAULT_MAX_LINES_IN_LISTBOX) { }
        public Logger(ListBox listBox, string messageFormat) : this(listBox, messageFormat, DEFAULT_MAX_LINES_IN_LISTBOX) { }
        public Logger(ListBox listBox, string messageFormat, int maxLinesInListbox)
        {
            _disposed = false;
